...
insert into student(id, name, passport_id) values(20001, 'Duke', 40001);
insert into student(id, name, passport_id) values(20002, 'May', 40002);
insert into student(id, name, passport_id) values(20003, 'Xuka', 40003);
